...
hi cursorim guifg=#341634 guibg=#effcff guisp=#effcff gui=NONE ctermfg=236 ctermbg=195 cterm=NONE
...
hi condtional guifg=#c6ccc7 guibg=NONE guisp=NONE gui=NONE ctermfg=151 ctermbg=NONE cterm=NONE
hi tagname guifg=#913991 guibg=#662a5a guisp=#662a5a gui=NONE ctermfg=96 ctermbg=53 cterm=NONE
hi lcursor guifg=#341634 guibg=#fdffef guisp=#fdffef gui=NONE ctermfg=236 ctermbg=230 cterm=NONE
hi cterm guifg=#cc782e guibg=#000000 guisp=#000000 gui=NONE ctermfg=166 ctermbg=NONE cterm=NONE
hi htmlitalic guifg=#341634 guibg=#c6ee01 guisp=#c6ee01 gui=NONE ctermfg=236 ctermbg=190 cterm=NONE
hi htmlboldunderlineitalic guifg=#22cc6b guibg=#000000 guisp=#000000 gui=NONE ctermfg=41 ctermbg=NONE cterm=NONE
hi gui guifg=#cc782e guibg=#000000 guisp=#000000 gui=NONE ctermfg=166 ctermbg=NONE cterm=NONE
hi htmlbolditalic guifg=#341634 guibg=#23e674 guisp=#23e674 gui=NONE ctermfg=236 ctermbg=41 cterm=NONE
hi htmlunderlineitalic guifg=#aacc02 guibg=#000000 guisp=#000000 gui=NONE ctermfg=148 ctermbg=NONE cterm=NONE
hi htmlbold guifg=#341634 guibg=#fa8938 guisp=#fa8938 gui=NONE ctermfg=236 ctermbg=215 cterm=NONE
hi htmlboldunderline guifg=#cc782e guibg=#000000 guisp=#000000 gui=NONE ctermfg=166 ctermbg=NONE cterm=NONE
hi htmlunderline guifg=#bd4bbd guibg=#000000 guisp=#000000 gui=NONE ctermfg=133 ctermbg=NONE cterm=NONE
hi htmllink guifg=#22cc6b guibg=#000000 guisp=#000000 gui=NONE ctermfg=41 ctermbg=NONE cterm=NONE
hi mbenormal guifg=#ba2a4c guibg=#0a253f guisp=#0a253f gui=NONE ctermfg=1 ctermbg=23 cterm=NONE
hi perlspecialstring guifg=#0105ba guibg=#401b40 guisp=#401b40 gui=NONE ctermfg=4 ctermbg=238 cterm=NONE
hi doxygenspecial guifg=#ccc6c7 guibg=NONE guisp=NONE gui=NONE ctermfg=252 ctermbg=NONE cterm=NONE
hi mbechanged guifg=#cc52cc guibg=#0a253f guisp=#0a253f gui=NONE ctermfg=170 ctermbg=23 cterm=NONE
hi mbevisiblechanged guifg=#cc52cc guibg=#898e8f guisp=#898e8f gui=NONE ctermfg=170 ctermbg=245 cterm=NONE
hi doxygenparam guifg=#ccc6c7 guibg=NONE guisp=NONE gui=NONE ctermfg=252 ctermbg=NONE cterm=NONE
hi doxygensmallspecial guifg=#ccc6c7 guibg=NONE guisp=NONE gui=NONE ctermfg=252 ctermbg=NONE cterm=NONE
hi doxygenprev guifg=#ccc6c7 guibg=NONE guisp=NONE gui=NONE ctermfg=252 ctermbg=NONE cterm=NONE
hi perlspecialmatch guifg=#0105ba guibg=#401b40 guisp=#401b40 gui=NONE ctermfg=4 ctermbg=238 cterm=NONE
hi cformat guifg=#0105ba guibg=#401b40 guisp=#401b40 gui=NONE ctermfg=4 ctermbg=238 cterm=NONE
hi doxygenspecialmultilinedesc guifg=#96475c guibg=NONE guisp=NONE gui=NONE ctermfg=132 ctermbg=NONE cterm=NONE
hi taglisttagname guifg=#c2cbcc guibg=NONE guisp=NONE gui=NONE ctermfg=152 ctermbg=NONE cterm=NONE
hi doxygenbrief guifg=#cc9eac guibg=NONE guisp=NONE gui=NONE ctermfg=181 ctermbg=NONE cterm=NONE
hi mbevisiblenormal guifg=#baba47 guibg=#898e8f guisp=#898e8f gui=NONE ctermfg=143 ctermbg=245 cterm=NONE
hi user2 guifg=#0d7587 guibg=#06515e guisp=#06515e gui=NONE ctermfg=30 ctermbg=23 cterm=NONE
hi user1 guifg=#72cc52 guibg=#06515e guisp=#06515e gui=NONE ctermfg=113 ctermbg=23 cterm=NONE
hi doxygenspecialonelinedesc guifg=#96475c guibg=NONE guisp=NONE gui=NONE ctermfg=132 ctermbg=NONE cterm=NONE
hi doxygencomment guifg=#965959 guibg=NONE guisp=NONE gui=NONE ctermfg=95 ctermbg=NONE cterm=NONE
hi cspecialcharacter guifg=#0105ba guibg=#401b40 guisp=#401b40 gui=NONE ctermfg=4 ctermbg=238 cterm=NONE
hi pythonimport guifg=#6f7b32 guibg=NONE guisp=NONE gui=NONE ctermfg=101 ctermbg=NONE cterm=NONE
hi pythonexception guifg=#cc52ba guibg=NONE guisp=NONE gui=NONE ctermfg=170 ctermbg=NONE cterm=NONE
hi pythonbuiltinfunction guifg=#6f7b32 guibg=NONE guisp=NONE gui=NONE ctermfg=101 ctermbg=NONE cterm=NONE
hi pythonoperator guifg=#188c7e guibg=NONE guisp=NONE gui=NONE ctermfg=30 ctermbg=NONE cterm=NONE
hi pythonexclass guifg=#6f7b32 guibg=NONE guisp=NONE gui=NONE ctermfg=101 ctermbg=NONE cterm=NONE
hi pythonbuiltin guifg=#237d3b guibg=NONE guisp=NONE gui=NONE ctermfg=2 ctermbg=NONE cterm=NONE
hi phpstringdouble guifg=#8f52cc guibg=NONE guisp=NONE gui=NONE ctermfg=98 ctermbg=NONE cterm=NONE
hi htmltagname guifg=#8f52cc guibg=NONE guisp=NONE gui=NONE ctermfg=98 ctermbg=NONE cterm=NONE
hi javascriptstrings guifg=#8f52cc guibg=NONE guisp=NONE gui=NONE ctermfg=98 ctermbg=NONE cterm=NONE
hi htmlstring guifg=#8f52cc guibg=NONE guisp=NONE gui=NONE ctermfg=98 ctermbg=NONE cterm=NONE
hi phpstringsingle guifg=#8f52cc guibg=NONE guisp=NONE gui=NONE ctermfg=98 ctermbg=NONE cterm=NONE
